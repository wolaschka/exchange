...
When a user attempts to approve Agreement Data items in the [Pending Screen](<approvals.md#pending>), a series of validations occur. The validations are performed to ensure that the data to be approved, is still valid at the time of the approval.
