...
There are three types of Margin Calculation tasks:
  ...
  1. Standard
  2. Group
  3. [Single](<agreements.md#run-single-margin-calculation>)
...
| Grouped | Agreement Groups | Select one, multiple or all [Combined Business Line Agreement Group(s)](<agreement_groups.md#combined-business-line-agreement-group>) to be applied to the configuration.  
