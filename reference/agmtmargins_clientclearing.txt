...
Coverage | This is a text field which allows the user to input information about the coverage of the agreement level margin. For example, the trade type could be indicated that it is to cover or that it is a total portfolio requirement. A maximum of 100 characters is allowed.  
...
Consider the following:
  ...
  * It is only possible to define Additional Margins for Client Clearing Agreements that have a Margin Type of Lock Up.

  * Margin Terms will be disabled and not visible when the Client Clearing Agreement has a Margin Type of Variation.

  * Unlike bilateral OTC Agreements, for Client Clearing Agreements, the user can only create an Agreement Margin with a Type identical to the Margin Type of the Agreement.

  * It is possible to Import Agreement Margins for Client Clearing Agreements.
