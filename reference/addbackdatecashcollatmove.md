# Source: https://qceqatwapp101.sd01.unicreditgroup.eu:5443/docs/addbackdatecashcollatmove.html
...
TLM Collateral provides functionality to [add standalone movements](<movements.md#create-a-manual-movement>) which can be entered with settlement dates within the open Interest Period if needed.

Note: Currently, it is only possible to enter backdated cash movements for open interest periods, not closed ones.

### Example

Assume today is the 3rd October, for an agreement with an Interest Period End date of 31st September, and that Interest Payments for the Period Ending September have been generated, but not yet completed.
...
If the user attempted to, the user would see a message similar to the one below and the movement would not be accepted: ![interestpaymentclosed.jpg](Images/interestpaymentclosed.jpg)

## Inclusion of In Transit Cash Collateral Movements
