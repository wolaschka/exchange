# Source: https://qceqatwapp101.sd01.unicreditgroup.eu:5443/docs/instruments_cash.html

# Cash Instrument

When a cash instrument is viewed, created or edited, it will contain 2 tabs of information. Each tab is described below.
...
Field | Description  
---|---  
Currency | Select the Currency from the drop-down list. This will be used as the PrimaryID and displayed accordingly. New currencies can be added through [reference data](<reference_related_data.md#currencies-and-fx-rates>).  
