# Source: https://qceqatwapp101.sd01.unicreditgroup.eu:5443/docs/buckets_equity.html

# Equity Buckets

Equity buckets can be [added](<buckets.md#create-buckets>), [edited](<buckets.md#edit-buckets>), or [deleted](<buckets.md#delete-buckets>).
...
| Stock Index | Select one or more Stock Indexes. If this field is blank, then stock index is not a filtered criteria.  
| Exchange | Select one or multiple Exchanges.  
...
Instrument Ratings | Structure | **ADD** \- To add an Instrument Rating to a new bucket, click the **Edit** button. Select the equity structure for the required ratings.  
...
**EDIT** \- To edit an Instrument Rating, click the **Edit** button to the equity bucket, then click the **Edit** button on the rating.  
  
**DELETE** \- To delete an Instrument Rating, click the **Edit** button to the equity bucket, then click the **Clear** button. The **Save** button must be clicked to save the changes made.  
...
**Note:** Not all Rating agencies have equivalencies defined for every ordinal within a equity structure. There may be situations where gaps exists.  
...
Issuer and Instrument Rating bands may use different equity structures to each other.
