# Source: https://qceqatwapp101.sd01.unicreditgroup.eu:5443/docs/buckets_loc.html

# Letter of Credit Buckets

Letter of Credit buckets can be [added](<buckets.md#create-buckets>), [edited](<buckets.md#edit-buckets>), or [deleted](<buckets.md#delete-buckets>).
...
| Issue Band | If Issue Date criteria needs to be included on the Letter of Credit Bucket, define the Issue date banding that will be used when evaluating Instruments.  
...
Issuer and Instrument Rating bands may use different letter of credit structures to each other.
...
If = is used and a rating equivalent to ordinal 2 is select the ratings will be displayed as shown below:
