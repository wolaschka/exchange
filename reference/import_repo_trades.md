...
[Validation message number 134](<validation_messages.md#134>).  
...
[Validation message number 113](<validation_messages.md#113>).  
...
[Validation message number 123](<validation_messages.md#123>).  
...
4\. If the Extension field defined is **Numeric** , the values on the import file must be within the minimum and maximum numbers defined on the reference data object. If not, then [validation message 233](<validation_messages.md#233>) will be raised and the value will not be loaded.  
