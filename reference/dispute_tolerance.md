# Source: https://qceqatwapp101.sd01.unicreditgroup.eu:5443/docs/dispute_tolerance.html

# Dispute Tolerances

## Defining Dispute Tolerances
...
| Examples  
---|---  
Percentage of Call Amount Dispute Tolerance Consider a 5% dispute tolerance | A Margin call of USD 1,000,000 is calculated and sent to a Counterparty.  
...
Fixed Amount Dispute Tolerance | Consider a USD 10,000 fixed amount Dispute Tolerance.  
...
Dispute Tolerances can be defined at two levels in the system:
  ...
  * At an [organization type level](<reference_related_data.md#organization-type>).

  * At an [individual agreement level](<agreement_actions.md#create-agreements>), dispute tolerances that are defined at agreement level take precedence over dispute tolerances defined at Organization level.
